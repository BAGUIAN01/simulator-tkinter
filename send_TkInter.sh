...
#description     :This script will compress all .py and .opt files in the current directory and send it to /home/TP/TPrendu/nedelec
#author		 :Maël CREAC'H
#date            :14/11/2023
#revision        :15/04/2024
#version         :0.4
#usage		 :bash send_to_nedelec.sh
...
rm -r ${folder_name}
cp ${folder_name}.tgz /home/TP/TPrendu/nedelec/CAI/TkInter
